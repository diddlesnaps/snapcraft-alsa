...
# module_dir = os.path.join(__location__, "../src/snapcraft_alsa_lib")
# try:
...
try:
    from snapcraft_alsa_lib import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'snapcraft_alsa_lib-doc'
...
intersphinx_mapping = {
    ...
    # 'scjsonnet': ('https://sc-jsonnet.readthedocs.io/en/latest', None),
    'scjsonnet': ('http://localhost:8088', None),
}
